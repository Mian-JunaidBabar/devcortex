          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            <div className="pt-3">
              ...
              <p className="text-lg text-slate-600 mb-4 leading-relaxed max-w-lg">
                Whether you need to <strong>build</strong> a new platform or <strong>scale</strong> your traffic with ads, we have the team to execute. Tell us about your goals.
              </p>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 text-lg">Response Time</h3>
                    <p className="text-slate-500 mb-1">We typically reply within 24 hours.</p>
                    <p className="text-slate-900 font-medium">Mon - Fri, 9am - 6pm (PKT)</p>
                  </div>
                </div>
              </div>
            </div>
